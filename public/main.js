...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Paginator = __webpack_require__(224);
	...
	var Main = _react2.default.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			fetch(magStructure).then(function (response) {
		...
		nextPage: function nextPage() {
			this.setState({
				...
				_reactRouter.browserHistory.push("/#" + this.state.pageNumber);
			});
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OnePage = _react2.default.createClass({
		displayName: 'OnePage',
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement('img', { src: this.props.assets })
			);
		}
	});
